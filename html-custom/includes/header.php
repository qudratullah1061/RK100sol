                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-xs-5">
                        <a href="index.html" title="Konsorts" class="logo">
                            <img src="img/logo.png" data-at2x="img/logo.png" class="logo-dark" alt="Konsorts">
                            <img src="img/logo.png" data-at2x="img/logo.png" alt="Konsorts" class="logo-light default">
                        </a>
                    </div>
                    <!-- end logo -->
