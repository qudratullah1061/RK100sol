                            ...
                            <div class="tab-content">
                                    ...
                                    <form role="form" id="update_companion_member" method="post">
                                        ...
                                        <div class="form-group col-md-12 text-right">
                                            <div class="margiv-top-10">
                                                ...
                                                <a href="<?php echo base_url('companions/get_companion_profile'); ?>" class="btn default"> Cancel </a>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </form>
                                ...
                                <div class="tab-pane" id="tab_1_4">
                                    <!-- Profile images start-->
                                        ...
                                        <div id="" class="margin-top-20 table-responsive">
                                            <div class="table-actions-wrapper">
                                                <span> </span>
                                                <a class="purple text-right" data-title="Add Type" href="javascript:Portfolios.modal_add_portfolio()"><i class="fa fa-plus-circle"></i> Add portfolio</a>
                                            </div>
                                            <table id="portfolio_table" class="table table-striped table-bordered table-hover table-checkable text-center dataTable no-footer" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $portfolio['country']; ?></td>
                                                            <td><?php echo $portfolio['state']; ?></td>
                                                            <td><?php echo $portfolio['city']; ?></td>
                                                            <td><?php echo date('Y-m-d',strtotime($portfolio['created_on'])); ?></td>
                                                            <td><?php echo date('Y-m-d',strtotime($portfolio['updated_on'])); ?></td>
                                                            <td><div class="md-checkbox-inline">
                                                                <div class="md-checkbox">
                                                            ...
                                                            <td><a class="btn btn-xs default btn-editable" onclick="Portfolios.modal_add_portfolio(<?php echo $portfolio['portfolio_id'];?>)">Edit</a> <a class="btn btn-xs default btn-editable" onclick="CommonFunctions.Delete(<?php echo $portfolio["portfolio_id"];?>  , 'tb_member_portfolios' , 'portfolio_id' , 'Category will be permanently deleted without further warning. Do you really want to delete this category?');">Delete</i></a></td>
                                                        </tr>
                                                        <?php } ?>
