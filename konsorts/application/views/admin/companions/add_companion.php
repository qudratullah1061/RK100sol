            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form">
                        ...
                        <div class="form-group form-md-radios">
                            <label>Radios - 111</label>
                            <div class="md-radio-inline">
                                <div class="md-radio">
                                    <input type="radio" id="radio1001" name="radio200" class="md-radiobtn">
                                    <label for="radio6">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box"></span> Option 1 </label>
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="radio1002" name="radio200" class="md-radiobtn" checked>
                                    <label for="radio7">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box"></span> Option 2 </label>
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="radio1003" name="radio200" class="md-radiobtn">
                                    <label for="radio8">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box"></span> Option 3 </label>
                                </div>
                                <a href="javascript:;" id="clickmewow" class="btn btn-success">Click</a>
                            </div>
                        </div>
                        <div class="form-group form-md-radios">
                            <label>Checkboxes</label>
