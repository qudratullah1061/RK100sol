var Languages = function () {
    ...
    var handleLanguageSubmit = function (formId) {
        $.ajax({
            type: "POST",
            url: base_url + "member/add_update_language",
            datatype: 'json',
    ...
    var show_modal_language = function (edit_id) {
        $.ajax({
            type: "POST",
            url: base_url + "member/modal_language",
            datatype: 'json',
            data: {language_id: edit_id},
            beforeSend: function ()
            {
...
//                    App.initMaterialDesign();
    ...
    return{
        modal_add_language: function (edit_id) {
            show_modal_language(edit_id);
        },
    }
}();