...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/global/css/components.css" rel="stylesheet" id="style_components"
          type="text/css"/>
    ...
    <link href="<?php echo base_url(); ?>assets/layouts/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css"
          id="style_color"/>
...
<div class="page-wrapper">
                                        ...
                                        <li>
                                            <a href="<?= site_url('admin/notifications/view_users_notifications?id=comment' . $notification['notify_id']) . $tab  ?>">
                                                ...
                                                <span class="details">
                                                        ...
                                                        </span><?php echo substr($notification['message'], 0, 39); ?><?php echo(strlen($notification['message']) > 40 ? '...' : ''); ?>
                                                    </span>
                                            </a>
                                        </li>
                                        <?php
                        ...
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <img alt="" class="img-circle"
                                 src="<?php echo base_url($this->admin_info['image_path'] . "/small_" . $this->admin_info['image']); ?>"/>
                        ...
                        <li class="nav-item start <?php ActivateParentLink('admin'); ?>">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item <?php ActivateCurrentLink('admin', 'admin_users'); ?>">
                                    <a href="<?php echo base_url('admin/admin_dashboard/admin_users'); ?>"
                                       class="nav-link ">
                        ...
                        <li class="nav-item <?php ActivateParentLink('companion'); ?>">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item <?php ActivateCurrentLink('companion', 'add'); ?>">
                                    <a href="<?php echo base_url('admin/companions/add_companion'); ?>"
                                       class="nav-link ">
                        ...
                        <li class="nav-item <?php ActivateParentLink('notifications'); ?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php ActivateCurrentLink('notifications', 'view_notifications'); ?>">
                                    <a href="<?php echo base_url('admin/notifications/view_notifications'); ?>"
                                       class="nav-link ">
                                        <!--<i class="fa fa-eye"></i>-->
                        ...
                        <li class="nav-item <?php ActivateParentLink('newsletters'); ?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php ActivateCurrentLink('newsletters', 'view_newsletters'); ?>">
                                    <a href="<?php echo base_url('admin/newsletters/view_newsletters'); ?>"
                                       class="nav-link ">
                                        <!--<i class="fa fa-eye"></i>-->
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar3.jpg" alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar1.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar4.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar2.jpg" alt="...">
                                    <div class="media-body">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar6.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar7.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar8.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar9.jpg" alt="...">
                                    <div class="media-body">
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> <?php echo date('Y'); ?> &copy; Konsorts Admin Panel. System Developed by
            <a target="_blank" href="http://100solutionz.net">100solutionz.net</a>
        </div>
