    ...
    <div class="col-lg-4 col-xs-12 col-sm-12">
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                <div class="scroller tab-content" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2" style="height: 450px;">
                                    ...
                                    <div class="mt-comment mt-comment-0-<?php echo $guest['member_id']; ?>" onclick="Chat.getChatMessages('0-<?php echo $guest['member_id']; ?>')">
                                        ...
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                                ...
                                                <span class="mt-comment-date"><span class="badge badge-danger member-<?php echo $guest['member_id']; ?>"></span></span>
                                            </div>
                                    ...
                                    <div class="mt-comment mt-comment-0-<?php echo $companion['member_id']; ?>" onclick="Chat.getChatMessages('0-<?php echo $companion['member_id']; ?>')">
                                        ...
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                                ...
                                                <span class="mt-comment-date"><span class="badge badge-danger member-<?php echo $companion['member_id']; ?>"></span></span>
                                            </div>
