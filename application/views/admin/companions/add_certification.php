            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input form-md-floating-label">
                    ...
                    <select class="form-control" name="approval_status">
                        ...
                        <option value="Approved" <?php echo (isset($certification_data->approval_status) && $certification_data->approval_status == 'Approved' ? 'selected' : ''); ?>>Approved</option>
                        <option value="Rejected" <?php echo (isset($certification_data->approval_status) && $certification_data->approval_status == 'Rejected' ? 'selected' : ''); ?> >Rejected</option>
