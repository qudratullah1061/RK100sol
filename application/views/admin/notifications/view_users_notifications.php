                                        ...
                                        <div class="mt-comment-body">
                                            ...
                                            <div class="mt-comment-details">
                                                <ul class="mt-comment-actions">
                                                    <li>
                                                        <a href="javascript:CommonFunctions.Delete('<?php echo $notification['notify_id']; ?>', 'tb_profile_notify', 'notify_id', 'Are you sure you want to delete this notification?')">Delete</a>
                                                    </li>
                                                    <?php
                                                    if ($notification['is_read'] == 0) {
                                                        ?>
                                                        <li>
                                                            <a href="javascript:CommonFunctions.MarkRead('<?php echo $notification['notify_id']; ?>', 'tb_profile_notify', 'notify_id', 'Are you sure you want to mark this notification as read?')">Mark
                                                                Read</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
