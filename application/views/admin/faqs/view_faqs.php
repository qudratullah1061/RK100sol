...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title">Faqs Listing</h3>
<!-- END PAGE TITLE-->
<!-- BEGIN Datatable-->
<div class="row">
    <div class="col-md-12">
            ...
            <div class="portlet-body">
                <div class="table-container">
                    <!--<div class="table-actions-wrapper">-->
                        <span> </span>
                        <a class="purple text-right" data-title="Add Faq" href="javascript:Faqs.modal_add_faq()"><i class="fa fa-plus-circle"></i> Add new FAQ</a>
                    <!--</div>-->
                    <table class="table table-striped table-bordered table-hover text-center" id="datatable_faqs">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" placeholder="Question" name="faq_question"> 
                                </td>
                                <td>
...
<script src="<?php echo base_url('assets/custom_scripts/admin/faqs.js'); ?>" type="text/javascript"></script>
<!-- End datatable-->
<script>
    $(document).ready(function () {
        DatatablesObj.InitFaqsTable('datatable_faqs');
    });
</script>