                                    ...
                                    <div class="content">
                                        <figure>
                                            <div class="portfolio-img  position-relative text-center overflow-hidden">
                                                <a href="<?php echo $this->session->userdata('member_type') == 1 ? base_url('member/profile/' . base64_encode($gold['member_id'])) : base_url('profile/memberInfo/' . base64_encode($gold['member_id'])); ?>">
