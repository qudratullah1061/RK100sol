        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large">
                <div class="display-table-cell vertical-align-middle text-center padding-30px-tb">
                    ...
                    <!-- end sub title -->
                    <!-- start page title -->
                    <h1 class="alt-font text-white font-weight-500 no-margin-bottom">Congratulations!</h1>
                    <!-- end page title -->
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 center-col padding-30px-bottom sm-margin-40px-bottom xs-margin-30px-bottom text-center">
                <h4 class="alt-font text-white font-weight-500">Thank you for registering on konsorts.com. Your account has been registered successfully. Please check your email to verify your account.</h4>
            </div>
