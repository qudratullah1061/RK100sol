        ...
        <section class="wow fadeIn">
            <div class="container"> 
                <div class="row equalize xs-equalize-auto">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin-80px-bottom sm-margin-50px-bottom xs-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-post blog-post-style2">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom xs-margin-15px-bottom">
                                <a href="<?php echo base_url('misc/blog_detail'); ?>">
                                    <img src="http://placehold.it/750x500" alt="Blog Detail Image">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin-80px-bottom sm-margin-50px-bottom xs-margin-30px-bottom wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-post blog-post-style2">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom xs-margin-15px-bottom">
                                <a href="<?php echo base_url('misc/blog_detail'); ?>">
                                    <img src="http://placehold.it/750x500" alt="Blog Detail Image">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin-80px-bottom sm-margin-50px-bottom xs-margin-30px-bottom wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-post blog-post-style2">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom xs-margin-15px-bottom">
                                <a href="<?php echo base_url('misc/blog_detail'); ?>">
                                    <img src="http://placehold.it/750x500" alt="Blog Detail Image">
                    ...
                    <!-- end post item -->
                    <!-- start post item -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 xs-margin-30px-bottom wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-post blog-post-style2">
                            <div class="blog-post-images overflow-hidden margin-25px-bottom xs-margin-15px-bottom">
                                <a href="<?php echo base_url('misc/blog_detail'); ?>">
                                    <img src="http://placehold.it/750x500" alt="Blog Detail Image">
