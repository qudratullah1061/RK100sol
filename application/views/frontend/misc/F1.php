            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="hosting-textture">
                        ...
                        <!--new-->
                        <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">5) Full Attention During the Workout</h5>
                ...
                <div class="col-md-6">
                    ...
                    <div class="hosting-textture">
                        <h5 class="text-purple font-weight-700 text-normal line-height-normal margin-5px-top margin-10px-bottom">What to expect from a personal training session</h5>
                        ...
                        <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">The first session</h5>
                        ...
                        <div class=" subheading">
                            <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">1. A full assessment or “Where are you at right now?”</h5>
                            ...
                            <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">2. Determine your goals or “Where do you want to go?”</h5>
                            ...
                            <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">3. Map out your training plan or “How to get there”</h5>
                        ...
                        <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">Being a personal trainer</h5>
                        ...
                        <h5 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">Find a personal trainer here...or become one!</h5>
