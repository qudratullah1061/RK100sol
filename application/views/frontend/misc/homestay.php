<!-- banner -->
<section class="wow fadeIn no-padding home-banner  margin-20px-bottom  xs-background-image-center" data-stellar-background-ratio="0.5" style="background-image:url('<?php echo base_url('assets/frontend/'); ?>img/homestay-banner.jpg');">
