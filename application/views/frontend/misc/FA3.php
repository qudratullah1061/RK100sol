<!-- banner -->
<section class="wow fadeIn no-padding home-banner  margin-20px-bottom  xs-background-image-center" data-stellar-background-ratio="0.5" style="background-image:url('<?php echo base_url('assets/frontend/'); ?>img/FA3.jpg');">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="swiper-full-screen swiper-container col-md-6 no-padding-lr white-move bg-extra-dark-gray text-center xs-padding-20px-tb wow fadeIn width-100">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide last-paragraph-no-margin">
                                <img src="<?php echo base_url('assets/frontend/img/FA3-A.jpg'); ?>" alt="">
                            </div>
                    ...
                    <div class="hosting-textture">
                        <h1 class="text-purple font-weight-700 text-normal line-height-normal margin-5px-top margin-10px-bottom"> Hire a local and explore the city on foot </h1>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">Benefits of hiring a local tour guide </h2>
                        ...
                        <div class="subheading">
                            <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">- They bring that “little bit extra”</h2>
                            ...
                            <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">- They know all the secret spots only locals know about</h2>
                            ...
                            <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">- They are usually cheaper</h2>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">How to find a local tour guide </h2>
                ...
                <div class="col-md-6">
                    <div class="swiper-full-screen swiper-container col-md-6 no-padding-lr white-move bg-extra-dark-gray text-center xs-padding-20px-tb wow fadeIn width-100">
                        <div class="swiper-wrapper">
                            <!-- start slider item -->
                            <div class="swiper-slide last-paragraph-no-margin">
                                <img src="<?php echo base_url('assets/frontend/img/FA3-B.jpg'); ?>" alt="">
                            </div>
                            <!-- end slider item -->
                        </div>
                        <!-- start slider pagination -->
                    ...
                    <div class="hosting-textture">
                        <h1 class="text-purple font-weight-700 text-normal line-height-normal margin-5px-top margin-10px-bottom">How to select a travel companion for an unforgettable trip </h1>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">What to look for in a travel companion</h2>
                        <p>If you don’t know where to start, here are a couple of areas that are most important when choosing a travel companion:</p>
                        <div class="subheading">
                            <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">Common interests</h2>
                            ...
                            <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">Matching personality</h2>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">“Test drive” your travel companion</h2>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">How should you pay your travel companion</h2>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal margin-5px-top margin-5px-bottom">Your travel companion - here</h2>
