            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="hosting-textture">
                        ...
                        <p>Well, a <b><a>personal shopper</a></b> / <b><a>fashion consultant</a></b> is the perfect solution for both.</p>
                        ...
                        <h2 class="text-purple font-weight-700 text-normal line-height-normal margin-10px-top margin-10px-bottom">How to <b><a>find a personal shopper</a></b> / fashion consultant?</h2>
                    ...
                    <div class="portfolio-grid work-4col gutter-large hover-option6 lightbox-portfolio">
                        <div class="swipper-pagination col-md-6 no-padding-lr white-move  text-center xs-padding-20px-tb wow fadeIn width-100">
                            <div class="swiper-wrapper">
                                ...
                                <!-- start portfolio item -->
                                <?php
                                echo $this->load->view('frontend/blogs/related_blog_articles', array('cat_id' => $cat_id), true);
                                ?>
                                <!-- end portfolio item -->
                            </div>
                            <!-- start slider pagination -->
