    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 center-col padding-30px-bottom sm-margin-40px-bottom xs-margin-30px-bottom text-center">
                <h5 class="alt-font text-white font-weight-500"><?php echo ( $verified ? 'Email verified successfully. Your account is now under review by admin of konsorts.com and will be approved within 24 hours. All provided information should be correct for verified accounts. <a href="' . base_url('auth/login') . '">Click here</a> to go to login page. Thanks.' : 'Email verification code is invalid. <a href="' . base_url() . '">Click here</a> to go to home page.'); ?></h5>
            </div>
