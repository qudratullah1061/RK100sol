        ...
        if (!$this->member_exists) {
            ...
            if ($this->member_info[0]['subscription_date'] == "0000-00-00 00:00:00") {
                ...
                if ($this->member_info[0]['member_type'] == 1) {
                    ...
                    return array('error' => 1, 'member_info' => $this->member_info[0], 'error_message' => "Your subscription has been expired. Please renew your subscription to use konsorts.com or contact at admin@konsorts.com.");
                }
