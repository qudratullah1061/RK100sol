var Portfolios = function () {
    ...
    var handlePortfolioSubmit = function (formId) {
        $.ajax({
            type: "POST",
            url: base_url + "admin/companions/add_update_portfolio",
            datatype: 'json',
    ...
    var show_modal_portfolio = function (edit_id, member_id) {
        $.ajax({
            type: "POST",
            url: base_url + "admin/companions/modal_portfolio",
            datatype: 'json',
            data: {portfolio_id: edit_id, member_id: member_id},
            beforeSend: function ()
            {
            ...
            success: function (data) {
                if (data.key) {
                    ...
                    $(".dd-country-portfolio").select2({
                        placeholder: "Select Country",
                        allowClear: true,
                        width: 'auto',
                    });
                    $(".dd-state-portfolio").select2({
                        placeholder: "Select State",
                        allowClear: true,
                        width: 'auto',
                    });
                    $(".dd-city-portfolio").select2({
    ...
    return{
        modal_add_portfolio: function (edit_id, member_id) {
            show_modal_portfolio(edit_id, member_id);
        },
    }
}();