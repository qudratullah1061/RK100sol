var Certifications = function () {
    ...
    var handleCertificationSubmit = function (formId) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "admin/companions/add_update_certification",
            datatype: 'json',
    ...
    var show_modal_certification = function (edit_id, member_id) {
       
        $.ajax({
            type: "POST",
            url: base_url + "admin/companions/modal_certification",
            datatype: 'json',
            data: {member_certification_id: edit_id, member_id:member_id},
            beforeSend: function ()
            {
...
//                    App.initMaterialDesign();
                    handleValidationAddCertification("form-add-cerification");
                }
            }
        });
    };
    ...
    return{
        modal_add_certification: function (edit_id, member_id) {
            show_modal_certification(edit_id, member_id);
        },
    }
}();