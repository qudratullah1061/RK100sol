    ...
    var InitFaqsDatatable = function (tableId) {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": base_url + "admin/faqs/get_faqs", // ajax source
                },
                "order": [
                    [0, "asc"]
                ], // set first column as a default sort by asc
                "aoColumnDefs": [
                    {'sName': 'Question', 'bSortable': true, 'aTargets': [0]},
                    {'sName': 'CreatedOn', 'bSortable': true, 'aTargets': [1]},
                    {'sName': 'UpdatedOn', 'bSortable': true, 'aTargets': [2]},
                    {'sName': 'CreatedBy', 'bSortable': true, 'aTargets': [3]},
                    {'sName': 'Status', 'bSortable': true, 'aTargets': [4]},
    ...
    var InitNewslettersDataTable = function (tableId) {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": base_url + "admin/newsletters/get_newsletters", // ajax source
                },
                "order": [
                    [0, "asc"]
                ], // set first column as a default sort by asc
                "aoColumnDefs": [
                    {'sName': 'Email', 'bSortable': true, 'aTargets': [0]},
                    {'sName': 'CreatedOn', 'bSortable': true, 'aTargets': [1]},
                    {'sName': 'Actions', 'bSortable': false, 'aTargets': [2]},
                ]
            }
        });
...
//                    {'sName': 'UpdatedOn', 'bSortable': true, 'aTargets': [6]},
    ...
    return {
        ...
        InitFaqsTable: function (tableId) {
            InitFaqsDatatable(tableId);
        },
        InitNewslettersTable: function (tableId) {
            InitNewslettersDataTable(tableId);
        },
