...
var Experiences = function () {
    ...
    var handleExperienceSubmit = function (formId) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "admin/companions/add_update_experience",
            datatype: 'json',
    ...
    var show_modal_experience = function (edit_id,member_id) {
       
        $.ajax({
            type: "POST",
            url: base_url + "admin/companions/modal_experience",
            datatype: 'json',
            data: {member_experience_id: edit_id,member_id : member_id},
            beforeSend: function ()
            {
...
//                    App.initMaterialDesign();
    ...
    return{
        modal_add_experience: function (edit_id,member_id) {
            show_modal_experience(edit_id,member_id);
        },
