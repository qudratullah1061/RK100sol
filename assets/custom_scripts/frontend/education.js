...
var Degrees = function () {
    ...
    var handleDegreeSubmit = function (formId) {
        $.ajax({
            type: "POST",
            url: base_url + "companions/add_update_degree",
            datatype: 'json',
    ...
    var show_modal_degree = function (edit_id) {
        $.ajax({
            type: "POST",
            url: base_url + "companions/modal_degree",
            datatype: 'json',
            data: {member_degree_id: edit_id},
            beforeSend: function ()
            {
...
//                    App.initMaterialDesign();
    ...
    return{
        modal_add_degree: function (edit_id) {
            show_modal_degree(edit_id);
        },
    }
}();