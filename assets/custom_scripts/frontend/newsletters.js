var Newsletters = function () {
    ...
    var handleNewsletterSubmit = function (formId) {
        $.ajax({
            type: "POST",
            url: base_url + "newsletters/add_update_newsletter",
            datatype: 'json',
    ...
    var handleValidationAddNewsletter = function (formId) {
    ...
    return{
        handle_newsletter: function () {
            handleValidationAddNewsletter("form-add-newsletter");
        }
    }
}();

$(document).ready(function(){
   Newsletters.handle_newsletter();
});